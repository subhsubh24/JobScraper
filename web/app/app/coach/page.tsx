...
export default function CoachPage() {
  ...
  async function send(text: string) {
    ...
    try {
      ...
      // coach look like it ignored a message it never got. Return the text to the input so it can
      // be resent without retyping, unless the user already started a new message.
